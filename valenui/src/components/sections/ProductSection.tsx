...
function ProductCard({ product, delay }: { product: Product; delay: number }) {
  ...
  return (
    ...
    >
        ...
        {product.features.map(f => (
          <li
            ...
            className="
              ...
              py-[5px] border-b border-gray-100 dark:border-white/[0.05] font-mono
              last:border-b-0
            "
          >
      ...
      {/* CTA */}
      <div className="pt-4 border-t border-gray-100 dark:border-white/[0.05] mt-auto">
        {product.ctaHref ? (
          <a
...
export function ProductSection() {
  ...
  return (
    <section id="products" className="py-[120px] px-6 bg-white dark:bg-[#111110]">
