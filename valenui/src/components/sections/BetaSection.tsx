...
export function BetaSection({ onSubmit }: BetaSectionProps) {
  ...
  return (
    <section className="py-32 px-6 relative bg-white dark:bg-black">
      {/* Background glow */}
      ...
      <div className="max-w-3xl mx-auto text-center relative">
        <div className="relative p-12 md:p-16 border border-gray-200 dark:border-gray-800 rounded-3xl bg-gray-50 dark:bg-gray-900/50 backdrop-blur-sm overflow-hidden">
          ...
          <div className="relative">
            ...
            {/* Heading */}
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-white leading-tight">
              Coding Arena
              <br />
            ...
            <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-6 py-4 bg-white dark:bg-gray-900/50 border ${
                    error ? 'border-red-500' : 'border-gray-300 dark:border-gray-700'
                  } rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:border-indigo-600 dark:focus:border-indigo-500 focus:ring-2 focus:ring-indigo-600/20 transition-all`}
